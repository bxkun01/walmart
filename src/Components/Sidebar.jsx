...
const Sidebar = forwardRef(function Sidebar({ visible }, ref) {
  return (
    <div
      ref={ref}
      className={`fixed top-0 bottom-0 left-0 text-sm text-slate-500 px-5 shadow-xl w-72 z-[666]
    ...
    >
      <div className="pb-5 pt-10 border border-transparent border-b-gray-300">
        <div className="gap-3 flex items-center pb-10">
          ...
          <span className="bg-blue-600 font-bold rounded-full p-1 cursor-pointer text-sm text-white hover:bg-blue-800">
